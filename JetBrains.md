...
# Security Skills for JetBrains AI

Apply these rules when generating, editing, or reviewing code. Security is a first-class constraint on all suggestions.

*Content aligned with [Claude.md](Claude.md); tailored for JetBrains AI (Junie) guidelines format.*
...
*Place in `.junie/guidelines/` for project-wide use.*
