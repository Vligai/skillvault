...
# Security Skills for Amazon Q Developer

Apply these rules when generating, editing, or reviewing code. Security is a first-class constraint on all suggestions.

*Content aligned with [Claude.md](Claude.md); tailored for Amazon Q Developer rules format.*
...
*Place in `.q/rules/` for project-wide use.*
