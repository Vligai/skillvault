  ...
  if (includeGuardrails) {
    ...
    if (fs.existsSync(dest)) {
      ...
      if (existingVersion === GUARDRAILS_VERSION) {
        ...
        if (!dryRun) fs.writeFileSync(dest, replaceGuardrailsBlock(existing, guardrails));
      ...
      if (!dryRun) fs.writeFileSync(dest, guardrails);
    ...
    if (platform.guardrailsAppendTarget) {
      ...
      if (fs.existsSync(dest)) {
        ...
        if (existingVersion === GUARDRAILS_VERSION) {
          ...
          if (!dryRun) fs.writeFileSync(dest, replaceGuardrailsBlock(existing, content));
