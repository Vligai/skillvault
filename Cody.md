...
# Security Skills for Sourcegraph Cody

Apply these rules when generating, editing, or reviewing code. Security is a first-class constraint on all suggestions.

*Content aligned with [Claude.md](Claude.md); tailored for Sourcegraph Cody rules format.*
...
*Place in `.cody/rules/` for project-wide use.*
