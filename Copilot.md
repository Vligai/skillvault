# Security Skills for GitHub Copilot

Apply these guidelines when generating, editing, or reviewing code. Security is a first-class constraint on all suggestions.

*Content aligned with [Claude.md](Claude.md); tailored for GitHub Copilot instructions format.*
...
*Add to `.github/copilot-instructions.md` or place in `.github/copilot/skills/` for project-wide use.*
