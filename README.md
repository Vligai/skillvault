...
- Input validation & injection prevention (SQL, XSS, command, path traversal)
- Authentication & authorization best practices
- Secrets management (never hardcode credentials)
- Cryptography (strong algorithms, TLS)
...
Contributions welcome. Keep skills concise, actionable, and platform-appropriate.
